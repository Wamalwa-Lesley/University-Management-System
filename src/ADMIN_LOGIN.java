...
public class ADMIN_LOGIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("  HI,WELCOME TO ADMIN LOGIN PAGE");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\User\\OneDrive\\Desktop\\aaaksupics\\k5.jpg")); // NOI18N
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        try{
            ...
            String sql="SELECT *FROM ADMIN WHERE NAME='"+user+"'&& ADMINID='"+password+"'";
            rs=stmt.executeQuery(sql);
            if(rs.next()){
                setVisible(false);
                ADMIN_HOMEPAGE object=new ADMIN_HOMEPAGE();
