...
public class HOD_EXAMTIMETABLE extends javax.swing.JFrame {
Connection conn=null;
    Statement stmt=null;
    ResultSet rs=null;
    /**
     * Creates new form HOD_EXAMTIMETABLE
     */
    public HOD_EXAMTIMETABLE() {
        super("Hod Exam");
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("  HI,WELCOME TO EXAM TIMETABLE PAGE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HOD_EXAMTIMETABLE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HOD_EXAMTIMETABLE().setVisible(true);
            }
        });
    }
