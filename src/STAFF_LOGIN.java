...
public class STAFF_LOGIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("  HI,WELCOME TO STAFF LOGIN PAGE");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\User\\OneDrive\\Desktop\\aaaksupics\\ksu6(1).png")); // NOI18N
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        try{
            ...
            String sql="SELECT *FROM STAFF WHERE NAME='"+user+"'&& STAFFID='"+password+"'";
            rs=stmt.executeQuery(sql);
            if(rs.next()){
                setVisible(false);
                STAFF_PAGE object=new STAFF_PAGE();
